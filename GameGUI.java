  ...
  */
  ...
  public int pickupPrize()
  {
    ...
    for (Rectangle p: prizes)
    {
      ...
      {
        numcoins += 1;
        System.out.println("YOU PICKED UP A PRIZE!" + numcoins);

				
        if (numcoins == 1){
    			try{
    				player = ImageIO.read(new File("onepoint.jpg")); // changes character icon
           ...
           System.err.println("Could not open file player.png");
    			...
    			try{
    				player = ImageIO.read(new File("amongus.png")); // changes character icon
            System.out.print("test");
            repaint();
    			} catch (Exception e) {
           System.err.println("Could not open file player.png");
    			...
    			try{
    				bgImage = ImageIO.read(new File("win.png")); // changes character icon
            System.out.print("test");
            repaint();
    			} catch (Exception e) {
           System.err.println("Could not open file player.png");
